...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-primary data-[state=checked]:shadow-[0_2px_10px_-3px_rgba(var(--primary),.3)]",
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "shadow-lg ring-0 transition-all duration-200",
        "data-[state=checked]:translate-x-5 data-[state=checked]:bg-primary-foreground",
        "data-[state=unchecked]:translate-x-0",
        "scale-95 data-[state=checked]:scale-100"
      )}
    />
  </SwitchPrimitives.Root>
));
